...
class OneOf(BaseComponent):
    def __init__(
        self,
        components: Sequence[Union[BaseComponent, str]],
    ...
    def _parse_components(
        self, components: Sequence[Union[BaseComponent, str]]
    ) -> Sequence[BaseComponent]:
        ...
        for component in components:
            ...
            if not isinstance(component, BaseComponent):
                raise TypeError(
                    f"component has to be of type 'BaseComponent' or 'str', not '{component.__class__.__name__}'"
                )
